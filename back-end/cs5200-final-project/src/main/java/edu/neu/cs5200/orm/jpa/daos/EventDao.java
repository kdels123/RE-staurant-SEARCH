...
public class EventDao {
	...
	// FIND Events by ownerId
	public List<Event> findEventsForOwner(int ownerId) {
	...
	public void updateEvent(int id, Event newEvent) {
		...
		if (optional.isPresent()) {
			...
			// String firstName = newOwner.getFirstName() != null ? newOwner.getFirstName()
			// : currOwner.getFirstName();
			// String address = newEvent.getAddress() != null ? newEvent.getAddress() :
			// currEvent.getAddress();
			// String attire = newEvent.getAttire() != null ? newEvent.getAttire() :
			// currEvent.getAttire();
			// String city = newEvent.getCity() != null ? newEvent.getCity() :
			// currEvent.getCity();
			...
			Restaurant restaurant = newEvent.getRestaurant() != null ? newEvent.getRestaurant()
					: currEvent.getRestaurant();
			List<Patron> attendees = newEvent.getPatronAttendees() != null ? newEvent.getPatronAttendees()
					: currEvent.getPatronAttendees();
	...
	public boolean existEvent(Event event) {
		...
		if (events != null) {
			for (Event e : events) {
				if (e.getTitle().equals(event.getTitle()) && e.getDateTime().equals(event.getDateTime())
						&& e.getOwner().equals(event.getOwner()) && e.getRestaurant().equals(event.getRestaurant())) {
					return true;
				}
			}
		}
